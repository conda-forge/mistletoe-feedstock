...
Once the `conda-forge` channel has been enabled, `mistletoe` can be installed with:

```
conda install mistletoe
```

It is possible to list all of the versions of `mistletoe` available on your platform with:
